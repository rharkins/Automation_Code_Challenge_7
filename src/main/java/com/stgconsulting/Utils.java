...
//            initialWordsRecord.setOccurrences(0);
    ...
    public void printWebpageWordsList() throws IOException {
        ...
        {
//            System.out.println('"' + wordsRecordIndex.getWord() + '"' + ", " + '"' + wordsRecordIndex.getWebsite() + '"' + ", " + '"' + wordsRecordIndex.getOccurrences() + '"');
    ...
    public void printTotalWordsList() throws IOException {
        ...
        {
//            System.out.println('"' + totalWordsRecordIndex.getWord() + '"' + ", " + '"' + totalWordsRecordIndex.getOccurrences() + '"');
